...
const data = {
  name: chalk.white('           Nathan Mausert'),
  handle: chalk.white('coffeegremlin'),
  shorthandle: chalk.white('coffeegremlin'),
  work: chalk.white('Full-Stack Engineer with Las Vegas Sands'),
  ...
  npx: chalk.red('npx') + ' ' + chalk.white('coffeegremlin'),
